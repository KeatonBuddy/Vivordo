...
String sleepInsightInfoText({required bool hasWhoopSleepData}) =>
    hasWhoopSleepData
    ? 'This insight was generated by Vivordo using sleep data imported from WHOOP. WHOOP provides the underlying sleep measurements; the interpretation shown here is created by Vivordo.'
    : 'This insight was generated by Vivordo using your sleep data. The interpretation shown here is created by Vivordo.';
...
class _SleepDetailScreenState extends State<SleepDetailScreen> {
    ...
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _lastUpdatedStatus(hasWhoopSleepData: hasWhoopSleepData),
            ...
            _stagesCard(
              averageStages,
              average,
              hasWhoopSleepData: hasWhoopSleepData,
            ),
            const SizedBox(height: 24),
            Row(
              children: [
                ...
                IconButton(
                  onPressed: () => _showInsightInfo(hasWhoopSleepData),
                  icon: const Icon(Icons.info_outline_rounded),
                  tooltip: 'About this insight',
  ...
  Widget _lastUpdatedStatus({required bool hasWhoopSleepData}) {
      ...
      child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        stream: user == null
            ...
            : FirebaseFirestore.instance
                  ...
                  .snapshots(),
        builder: (context, snapshot) {
          final whoopConnected = hasConnectedWhoop(snapshot.data?.data());
          return Wrap(
            ...
            children: [
              ...
              if (whoopConnected && hasWhoopSleepData) ...[
                Text(
                  '· Data includes',
                  style: TextStyle(color: context.vivordoColors.textSecondary),
                ),
  ...
  Widget _stagesCard(
    ...
    double average, {
    required bool hasWhoopSleepData,
  }) {
    if (stages.isEmpty) {
      return _card(
        padding: const EdgeInsets.all(22),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    hasWhoopSleepData
                        ? 'Total sleep is available, but WHOOP did not provide stage details.'
